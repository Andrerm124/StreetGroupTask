...
export default {
  ...
  buttonPadding: 6,
  btnPrimaryBg: 'rgba(100,189,158,1)',
  btnPrimaryColor: '#fff',
  btnInfoBg: '#3F57D3',
  btnInfoColor: '#fff',
  btnSuccessBg: '#5cb85c',
  ...
  brandPrimary: 'rgba(100,189,158,1)',
  brandInfo: '#3F57D3',
  brandSuccess: '#5cb85c',
  brandDanger: '#d9534f',
  brandWarning: '#f0ad4e',
  ...
  toolbarBtnColor: '#fff',
  toolbarDefaultBg: 'rgba(100,189,158,1)',
  ...
  toolbarDefaultBorder: 'rgba(77,77,77,1)',
  iosStatusbar: 'light-content',
  statusBarColor: 'rgba(100,189,158,1)',
  darkenHeader: '#F0F0F0',
  iconFamily: 'Ionicons',
  iconFontSize: 30,
  iconHeaderSize: 29,
